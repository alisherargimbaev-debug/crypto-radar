...
// Закрытые сделки больше НЕ пишутся в БД из этого пути.
// Это paper-симуляция; live сделки сохраняются только через autoexec.js → trades.
// Удаляем только записи из open_trades (для cleanup).
